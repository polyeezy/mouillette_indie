...
// Last update Sun Jun  5 08:09:05 2016 Valérian Polizzi
//
...
{
  this->addEntity(new Button(new Vec3(10, 2, 2), new Vec3(0, 30, 0), "Jouer",  "materials/jouer.png"));
  this->addEntity(new Button(new Vec3(10, 2, 2), new Vec3(0, 0, 0), "Options", "materials/jouer.png"));
  this->addEntity(new Button(new Vec3(10, 2, 2), new Vec3(0, -30, 0), "Quitter", "materials/jouer.png"));
